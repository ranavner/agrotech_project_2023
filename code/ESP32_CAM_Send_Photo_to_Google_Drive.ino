...
const char* ssid = "HUJI-guest";
const char* password = "";
//======================================== 

//======================================== Replace with your "Deployment ID" and Folder Name.
String myDeploymentID = "AKfycbziDMNTQ7PVVinxhdmju7QGuIqQ0nibcpYQGsOvY84EIYzmJ4Pkair0Wbgl_hVxcoQ";
String myMainFolderName = "ESP32-CAM";
//======================================== 

//======================================== Variables for Timer/Millis.
unsigned long previousMillis = 0; 
const int Interval = 10*60*1000 ; //--> Capture and Send a photo every 10 minutes.
//======================================== 
...
void setup() {
  ...
  Serial.println();
  Serial.println("ESP32-CAM captures and sends photos to the server every 10 minutes.");
  Serial.println();
  delay(2000);
}
//________________________________________________________________________________ 
